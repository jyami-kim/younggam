...
public interface OrderMapper {
    ...
    @Select("SELECT cu.id AS customerId, cr.chatroom_code, om.order_id, cu.name, cu.phone_num, om.pickup_time, os.total_payment, os.payment_method, om.order_status, GROUP_CONCAT(p.name SEPARATOR ',') AS productList, GROUP_CONCAT(od.amount) AS amountList, false AS inquiries " +
