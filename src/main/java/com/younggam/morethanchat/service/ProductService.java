...
public class ProductService {
    ...
    public List<ProductResDto> getTodayStoreProduct(Long providerId, String searchDate) {
        List<Product> products = productMapper.findByTodayProduct(providerId, searchDate);
        if (products.isEmpty())
